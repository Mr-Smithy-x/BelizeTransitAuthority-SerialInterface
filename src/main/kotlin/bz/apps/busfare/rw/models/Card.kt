...
import bz.apps.busfare.rw.extensions.toByteArray
import bz.apps.busfare.rw.extensions.toLong
import bz.apps.busfare.rw.helpers.Cryption.encrypt
    ...
    sealed class Flag(
        ...
        companion object {
            ...
            fun createClassicCard(
                ...
                return Classic(classicCardType, routeCardType, activation)
            }
            ...
            fun createSubscriptionCard(
                ...
                return Subscription(subscriptionCardType, routeCardType, activation)
            }
            ...
            fun createStudentCard(
                ...
                return Student(studentCardType, routeCardType, activation)
            }
            ...
            fun createMunicipalCard(
                ...
                return Municipal(municipalCardType, routeCardType, activation)
            }
